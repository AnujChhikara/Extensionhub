      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14">
          ...
          >
            ...
            <span className="text-lg font-bold text-white">ExtensionSpot</span>
            </Link>
          </motion.div>
            ...
            >
              <Link href="/extensions" className="text-gray-300 hover:text-white transition-colors text-sm">Extensions</Link>
              ...
              <a href="#roadmap" className="text-gray-300 hover:text-white transition-colors text-sm">Roadmap</a>
