...
export function ExtensionDescription({ extensionId }: ExtensionDescriptionProps) {
  ...
  return (
    ...
    >
      <h2 className="text-xl font-semibold text-white mb-6">About this extension</h2>
      ...
      <div>
        ...
        <p className="text-xs text-gray-500 mt-3">
          This extension requires these permissions to function properly. You can review and manage permissions in your browser settings.
        </p>
      </div>
    </motion.div>
  );
