        ...
        <div className="space-y-3">
          <label className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-gray-300 text-sm">Extension approval notifications</span>
            </div>
          </label>
          ...
          <label className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-gray-300 text-sm">New review notifications</span>
            </div>
          </label>
          ...
          <label className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-2">
              <Mail className="h-4 w-4 text-gray-400" />
              <span className="text-gray-300 text-sm">Weekly digest emails</span>
            </div>
          </label>
        </div>
      </div>
        ...
        <div className="space-y-3">
          <label className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-gray-300 text-sm">Show profile to other users</span>
            </div>
          </label>
          ...
          <label className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-2">
              <Shield className="h-4 w-4 text-gray-400" />
              <span className="text-gray-300 text-sm">Allow analytics tracking</span>
            </div>
          </label>
        </div>
      </div>
