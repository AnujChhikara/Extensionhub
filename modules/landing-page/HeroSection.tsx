...
import { ArrowRight, Check, Chrome, Search, Star, Sparkles } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-4xl lg:text-5xl font-bold text-white leading-tight">
              ...
              <span className="block font-serif text-gray-200">Chrome Extensions</span>
            </h1>

            <p className="text-lg text-gray-400 max-w-lg">
              Find underrated, emerging, and niche Chrome extensions that enhance your browsing experience. No signup required.
            </p>

            <div className="flex flex-col sm:flex-row gap-3">
              <Button size="md" variant="primary" onClick={() => window.location.href = '/extensions'}>
                Start Exploring <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
              <Button variant="outline" size="md" onClick={() => window.location.href = '/extensions'}>
                View Examples
              </Button>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-3 text-gray-300">
                <Check className="h-4 w-4 text-white" />
                <span className="text-sm">Analytics & Performance Insights</span>
              </div>
            </div>
          </motion.div>
                ...
                <div className="bg-white/5 backdrop-blur-md rounded-lg p-3 border border-black">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <h3 className="text-white font-semibold text-sm">Productivity Pro</h3>
                      <p className="text-gray-400 text-xs">Enhance your workflow with smart shortcuts</p>
                      <div className="flex items-center space-x-2 mt-1">
                        ...
                        <span className="text-gray-400 text-xs">10K+ users</span>
                      </div>
                    </div>
                  </div>
                </div>
